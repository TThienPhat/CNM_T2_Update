      ...
      case "messenger":
        return (
          <View style={styles.tabContent}>
            ...
            <Text style={styles.tabPlaceholder}>Tin nhắn của bạn sẽ hiển thị tại đây</Text>
          </View>
        );
      case "contacts":
        return (
          <View style={styles.tabContent}>
            ...
            <Text style={styles.tabPlaceholder}>Danh bạ của bạn sẽ hiển thị tại đây</Text>
          </View>
        );
      case "profile":
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tabBar}>
        ...
        >
          <Ionicons
            name={activeTab === "messenger" ? "chatbubbles" : "chatbubbles-outline"}
            size={24}
        ...
        >
          <MaterialIcons
            ...
            color="#FF3B30"
          />
          <Text style={[styles.tabLabel, { color: "#FF3B30" }]}>
            Đăng xuất
          </Text>
        </TouchableOpacity>
      </View>
